...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoogleProduct.publish_google_shopping'
        db.add_column(u'gmerchant_googleproduct', 'publish_google_shopping',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'GoogleProduct.google_taxonomy'
        db.add_column(u'gmerchant_googleproduct', 'google_taxonomy',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gmerchant.GoogleCategory'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'GoogleProduct.google_shopping_description'
        db.add_column(u'gmerchant_googleproduct', 'google_shopping_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GoogleProduct.publish_google_shopping'
        db.delete_column(u'gmerchant_googleproduct', 'publish_google_shopping')

        # Deleting field 'GoogleProduct.google_taxonomy'
        db.delete_column(u'gmerchant_googleproduct', 'google_taxonomy_id')

        # Deleting field 'GoogleProduct.google_shopping_description'
        db.delete_column(u'gmerchant_googleproduct', 'google_shopping_description')
