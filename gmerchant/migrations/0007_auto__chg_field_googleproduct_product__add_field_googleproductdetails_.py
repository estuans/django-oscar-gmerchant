...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GoogleProduct.product'
        db.alter_column(u'gmerchant_googleproduct', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gmerchant.GoogleProductDetails']))
        # Adding field 'GoogleProductDetails.publish_google_shopping'
        db.add_column(u'gmerchant_googleproductdetails', 'publish_google_shopping',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'GoogleProductDetails.google_taxonomy'
        db.add_column(u'gmerchant_googleproductdetails', 'google_taxonomy',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gmerchant.GoogleCategory'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'GoogleProductDetails.google_shopping_description'
        db.add_column(u'gmerchant_googleproductdetails', 'google_shopping_description',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'GoogleProduct.product'
        db.alter_column(u'gmerchant_googleproduct', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Product']))
        # Deleting field 'GoogleProductDetails.publish_google_shopping'
        db.delete_column(u'gmerchant_googleproductdetails', 'publish_google_shopping')

        # Deleting field 'GoogleProductDetails.google_taxonomy'
        db.delete_column(u'gmerchant_googleproductdetails', 'google_taxonomy_id')

        # Deleting field 'GoogleProductDetails.google_shopping_description'
        db.delete_column(u'gmerchant_googleproductdetails', 'google_shopping_description')
    ...
    models = {
        ...
        u'gmerchant.googleproduct': {
            'Meta': {'object_name': 'GoogleProduct'},
            'google_shopping_created': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'google_shopping_id': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '128', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gmerchant.GoogleProductDetails']"}),
            'product_upc': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '32', 'null': 'True', 'blank': 'True'})
        },
        u'gmerchant.googleproductdetails': {
            'Meta': {'object_name': 'GoogleProductDetails'},
            'google_product': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['gmerchant.GoogleProduct']", 'unique': 'True'}),
            'google_shopping_description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'google_taxonomy': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gmerchant.GoogleCategory']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['catalogue.Product']", 'unique': 'True'}),
            'publish_google_shopping': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        }
    }
