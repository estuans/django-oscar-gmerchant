...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoogleProduct.product_upc'
        db.add_column(u'gmerchant_googleproduct', 'product_upc',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding index on 'GoogleProduct', fields ['google_shopping_id']
        db.create_index(u'gmerchant_googleproduct', ['google_shopping_id'])


    def backwards(self, orm):
        # Removing index on 'GoogleProduct', fields ['google_shopping_id']
        db.delete_index(u'gmerchant_googleproduct', ['google_shopping_id'])

        # Deleting field 'GoogleProduct.product_upc'
        db.delete_column(u'gmerchant_googleproduct', 'product_upc')
    ...
    models = {
        ...
        u'catalogue.category': {
            ...
            'cover_product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalogue.Product']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'depth': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'full_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'icon': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['iconlib.Icon']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'is_gift_category': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'catalogue.product': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'featured_product': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ingredients': ('django.db.models.fields.TextField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            ...
            'priority': ('django.db.models.fields.PositiveIntegerField', [], {'default': '99'}),
        ...
        u'iconlib.icon': {
            ...
            'has_svg': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
